...
export const CheckData = ({passengers, train, totalPrice, personalData}) => {
    ...
    useEffect(() => {
        if (successOrder) {
            successOrder.status ? navigate('/basado-en-daritat/result/') : null
        }
    }, [successOrder])
            ...
            <section className="check-data-block">
                <div className="check-data-train-info">
                    ...
                    <div className="check-data-train-card">
                        ...
                        <div className='train-card-conditions'>
                            ...
                            <button className='btn train-card-change-btn' onClick={() => navigate('/basado-en-daritat/trains')}>Изменить</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='check-data-passengers-info'>
                        ...
                        <div className='check-data-passengers-result-block'>
                            <div className='check-data-passengers-result-block-block'>
                                ...
                                <button className='btn train-card-change-btn' onClick={() => navigate('/basado-en-daritat/passengers/')}>Изменить</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='check-data-payment-block'>
                    ...
                    <div className='check-data-payment-info'>
                        ...
                        <button className='btn train-card-change-btn' onClick={() => navigate('/basado-en-daritat/payment/')}>Изменить</button>
                    </div>
                </div>
